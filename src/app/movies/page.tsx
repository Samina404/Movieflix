    ...
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
      <div className="relative">
        ...
        <div className="border-b border-foreground/10 pb-12">
          ...
          <p className="text-foreground-muted text-base md:text-lg max-w-2xl font-medium leading-relaxed">
      ...
      <Suspense fallback={<div className="h-96 animate-pulse bg-foreground/5 rounded-2xl" />}>
      ...
      <div className="flex flex-wrap justify-center items-center gap-2 mt-12 pb-10">
        <Link
          ...
          className={`px-4 py-2 rounded-lg bg-foreground/5 border border-foreground/10 hover:bg-foreground/10 transition-colors ${currentPage === 1 ? 'pointer-events-none opacity-50' : ''}`}
        >
          Previous
        </Link>
          ...
          <Link
            ...
            className={`w-10 h-10 flex items-center justify-center rounded-lg border transition-all ${
              currentPage === pageNum 
                ...
                : 'bg-foreground/5 border-foreground/10 text-foreground-muted hover:bg-foreground/10 hover:text-foreground'
            }`}
          >
            {pageNum}
          </Link>
        ...
        <Link
          ...
          className={`px-4 py-2 rounded-lg bg-foreground/5 border border-foreground/10 hover:bg-foreground/10 transition-colors ${currentPage === totalPages ? 'pointer-events-none opacity-50' : ''}`}
        >
          Next
        </Link>
      </div>
